...
def authenticate():
    ...
    if os.path.exists('token.json'):
        creds = Credentials.from_authorized_user_file(r'Backend\token.json', ['https://www.googleapis.com/auth/gmail.readonly'])
    else:
        flow = InstalledAppFlow.from_client_secrets_file(r'Backend\credentials.json', ['https://www.googleapis.com/auth/gmail.readonly'])
...
authenticate()
emails = retrieveUncheckedEmailContents()
data = parseEmailData(emails)